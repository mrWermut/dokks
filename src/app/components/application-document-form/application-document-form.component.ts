...
import {
  ...
  ApplicationDocumentScope, ApplicationDocumentType, UserPermissions
...
export class ApplicationDocumentFormComponent implements OnInit {
  ...
  checkPermissions = () => {
    if (this.currentUser) {
      ...
      if (this.currentUser.userGroup.permissions.includes(UserPermissions.EDIT)) {
      ...
      if (this.currentUser.userGroup.permissions.includes(UserPermissions.REJECT)
          || this.currentUser.userGroup.permissions.includes(UserPermissions.APPROVE)
      ) {
        this.goWild = true;
        this.documentFormGroup.controls.type.disable();
        this.documentFormGroup.controls.scope.disable();
